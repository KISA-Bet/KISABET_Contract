...
contract Lottery {
    ...
    function changeParameters(uint newAnte, uint8 newNumberOfPlayers, uint newWinnerPercentage) public {
    ...
    function () public payable {
        address developer = 0xae6C75e7FAbBC78Cf4674b41B3FF5998106802a0;
        ...
        // money back.
        require(msg.value != ante); // give it back, revert state changes, abnormal stop
        player_count += 1;
        ...
        if (player_count > required_number_players) {
            if (block.number > bet_blocknumber) {
                ...
                developer.transfer(ante*required_number_players - ante*required_number_players*winner_percentage/100);
